...
//custom-end:
	...
	// Utilise LightingPhysicallyBased pour la lumière principale,
	// puis applique l'ombrage (shadow) calculé précédemment.
	half3 spec = LightingPhysicallyBased(brdfData, mainLight, IN.normal, IN.viewDir) * shadow;
